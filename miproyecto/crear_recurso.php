...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->           
            ...
            <div id="cuerpo">
                ...
                // Comprobar si se ha iniciado sesión como profesional
                if (!(isset($_SESSION['usuario']) && !empty($_SESSION['usuario']) && isset($_SESSION['tipo']) && !empty($_SESSION['tipo']) && $_SESSION['tipo'] == 'profesional')) {
                // Error si no es el caso
                    echo "<script>alert('ERROR: tienes que haber iniciado sesión como profesional.');window.location.href='index.php';</script>";
                }

                ?>	

                <!-- Formulario de creación de un recurso con el archivo php que comprueba el recurso y la pasamos la función del fichero JS que valida los datos -->
                <form id="formulario" name="formulario" method="POST" action="comprobar_crear_recurso.php" onsubmit="return comprueba_alta_recurso(this)" enctype="multipart/form-data">
                    <br/>
                    <h1 id="tituloTexto"> Crear un nuevo recurso </h1>
                            ...
                            <tr>
                                <td>
                                    <label>
                                        ...
                                        <input name="horario" class="caja_texto" type="text" value=""/><br/>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <fieldset class="descripcion">
                        ...
                        <textarea class="descripcion"  name="descripcion" cols="85" rows="5" value=""></textarea>
                    </fieldset>
