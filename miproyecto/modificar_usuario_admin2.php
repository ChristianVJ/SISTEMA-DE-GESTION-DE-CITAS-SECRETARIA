...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// --> 
            ...
            <div id="cuerpo">
                ...
                <form name="formulario" method="post" action="comprobar_modificar_usuario_admin.php" enctype="multipart/form-data">

                    <h2 id="tituloTexto">Modificar usuario</h2> 
                    <fieldset class="iniciarSesion">
                        <table class="tabla_registrarse">
                            <tr>
                                <td>
                                    <label> Nombre
                                        <input name="nombre" class="caja_texto" maxlength="40"   type="text" value="<?php echo $registro['nombre']; ?>" />
                                    </label>
                                </td>
                                <td>
                                    <label> Apellidos 
                                        <input name="apellidos" class="caja_texto" maxlength="40" type="text" value="<?php echo $registro['apellidos'] ?>"/>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label>
                                        Correo electrónico 
                                        <input name="email" class="caja_texto" maxlength="40" type="text" value="<?php echo $registro['email'] ?>"/>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label>
                                        Crea una contraseña
                                        <input name="clave" class="caja_texto" type="password" value="value="<?php echo $registro['clave'] ?>"" />
                                    </label>
                                </td>
                                <td>
                                    <label>
                                        ...
                                        <input name="repite_clave" class="caja_texto" type="password" value="value="<?php echo $registro['clave'] ?>"" />
                                    </label>
                                </td>
                            </tr>
                        </table>
                    ...
                    <input type="hidden" name="antiguo_nombre" value="<?php echo $registro['nombre']; ?>" />
                    <fieldset id="botones">
                        <table class="tabla_registrarse">
                            <tr>
                                <td>
