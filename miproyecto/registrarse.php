...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// --> 
            ...
            <div id="cuerpo">
                <!-- Formulario de registro con el archivo php que comprueba el registro y la pasamos la función del fichero JS que valida los datos -->
                <form method="post" action="comprobar_registro.php" onsubmit="return comprueba_registrarse(this)" > 
                    <h2 id="tituloTexto">Nuevo usuario</h2>
                    <fieldset id="registrarse"> 
                        <!-- Tabla de registro para datos -->
                        <table class="tabla_registrarse"  cellpadding="10">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <label>
                                        <select name="sexo">
                                            <option selected="sin especificar" id="SeleccionarSexo" value="sin especificar" > Sin especificar </option>
                        ...
                        <!-- Tabla de registro para indicar tipo de usuario -->
                        <div id="registrarseComo">                  
                            Registrarse como:
                            <input type="radio" name="registrarse_como"  checked value="cliente"/>Cliente
                            <input type="radio" name="registrarse_como" value="profesional"/>Profesional
                        </div>
                    </fieldset>
                    ...
                    <fieldset id="botones"> 
                        <table class="tabla_registrarse">
                            <tr>
                                <td>
                                    <input type="submit" value="Registrarse" /> <!-- Enviar los datos -->
