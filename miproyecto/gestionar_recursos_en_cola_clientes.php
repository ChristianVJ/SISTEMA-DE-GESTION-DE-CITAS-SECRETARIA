...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// --> 
            ...
            <div id="cuerpo">
                <h1 id="tituloTexto"> Recursos asignados</h1>
                <?php
                    ...
                    echo '<tr id = "cabecera_recursos"><td class="tdt1"><b>Código del usuario</b></td><td class="tdt1"><b>Código del recurso</b></td><td class="tdt1"><b>DNI</b></td><td class="tdt1"><b>Estado</b></td><td class="tdt1"><b>Hora de asignación</b></td></td></tr>';

                    //los recursos asignados a cada cliente
                    $consulta = 'SELECT * FROM recurso_asignado WHERE usuario="' . $_SESSION['usuario'] . '"';
                    ...
                    while ($registroActual = mysql_fetch_array($resultado)) {
                        echo '<tr>';
                        echo '<td>';
                        echo $registroActual['codigo_usuario'];
                        echo '</td><td>';
                        echo $registroActual['codigo_recurso'];
                        echo '</td><td>';
                        echo $registroActual['DNI'];
                        echo '</td><td>';
                        echo $registroActual['Estado'];
                        echo '</td><td>';
                        echo $registroActual['hora_asignacion'];
                        echo '</td>';
                    }
                ...
                <p id="texto" >
                    Aquí encontrará sus recursos asignados junto a la posición que se encuentra en la cola. Espere a recibir su turno. 
                    <br>¡Gracias por su paciencia!</br> 
                </p>
            </div>
