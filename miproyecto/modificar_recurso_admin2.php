...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// --> 
            ...
            <div id="cuerpo">
                ...
                // Los datos del recurso seleccionado
                $consulta = "SELECT * FROM recursos where nombre_recurso='" . $_GET['nombre_recurso'] . "'";
                ...
                <!-- Formulario que nos permite modificar el recurso  -->
                <form name="formulario" method="post" action="comprobar_modificar_recurso.php" enctype="multipart/form-data">

                    <h2 id="tituloTexto">Modificar recurso</h2> 
                            ...
                            <tr>
                                <td>
                                    <label>
                                        ...
                                        <input name="nombre_recurso" class="caja_texto" type="text" value="<?php echo $registro['nombre_recurso']; ?>"/>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label>
                                        Horario de comienzo<br/>
                                        <input name="horario" class="caja_texto" type="text" value="<?php echo $registro['horario']; ?>"/>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label>
                                        Lugar<br/>
                                        <input name="lugar" class="caja_texto" type="text" value="<?php echo $registro['lugar']; ?>"/>
                                    </label>
                                </td>
                            </tr>
                        </table>
                    ...
                    <fieldset class="descripcion">
                        <legend> Descripción del recurso </legend>
                        <textarea class="descripcion"  name="descripcion" cols="70" rows="12" value=""><?php echo $registro['descripcion']; ?></textarea>
                    </fieldset>
                    <input type="hidden" name="antiguo_nombre_recurso" value="<?php echo $registro['nombre_recurso']; ?>" />
                    <fieldset id="botones">
                        <table class="tabla_registrarse">
                            <tr>
                                <td>
