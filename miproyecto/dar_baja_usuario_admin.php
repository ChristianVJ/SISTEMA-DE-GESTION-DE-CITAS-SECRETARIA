...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// --> 
            ...
            <div id="cuerpo">
                <h1 id="tituloTexto"> Dar de baja un usuario</h1>
                <?php
                  include ('include.php');
                ...
                <form id="formulario" name="formulario" method="POST" action="elimina_usuario_admin.php" onsubmit="return comprueba_baja_usuario(this)" enctype="multipart/form-data">
                    <br/>
                        ...
                        <table class="tabla_registrarse">
                            <tr>
                                <td>
                                    <label>
                                        Usuario<br/>
                                        <input name="usuario" class="caja_texto" type="text" value=""/><br/>
                                    </label>
                                </td>
                            </tr>
                        </table>
                            ...
                            <table class="tabla_registrarse">
                                <tr>
                                    <td>
                                        ...
                                        <input type="submit" value="Enviar" href="elimina_usuario_admin.php?usuario=' . $registroActual['usuario'] . '" />
