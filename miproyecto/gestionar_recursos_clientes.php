...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// --> 
            ...
            <div id="cuerpo">
                <h1 id="tituloTexto"> Recursos disponibles</h1>
                <?php
                    include ('include.php');//referencia el fichero include en el que se realiza la conexión con la base de datos
                    ...
                    //Cabecera de la tabla en la que se muestra los resultado de la consulta
                    echo '<table id="tablaCuerpo">';
                    echo '<tr id = "cabecera_recursos"><td class="tdt1"><b>Código del recurso</b></td><td class="tdt1"><b>Nombre del recurso</b></td><td class="tdt1"><b>Descripción</b></td><td class="tdt1"><b>Lugar</b></td><td class="tdt1"><b>Horario</b></td></td></tr>';
                    ...
                    while ($registroActual = mysql_fetch_array($resultado)) {
                        echo '<tr>';
                        echo '<td>';
                        echo $registroActual['codigo_recurso'];
                        echo '</td><td>';
                        echo $registroActual['nombre_recurso'];
                        echo '</td><td>';
                        echo $registroActual['descripcion'];
                        echo '</td><td>';
                        echo $registroActual['lugar'];
                        echo '</td><td>';
                        echo $registroActual['horario'];
                ...
                ?>	
                 <form id="formulario_darse_alta_recurso_cliente" name="formulario" method="POST" action="comprueba_alta_recurso_cliente.php" onsubmit="return comprueba_alta_recurso(this)" enctype="multipart/form-data">
                    <br/>
                    <h1 id="tituloTexto_dar_alta_recurso_cliente"> Darse de alta </h1>
                    <fieldset class="iniciarSesion">
                        <table class="tabla_registrarse">
                            <tr>
                                <td>
                                    <label>
                                        Nombre<br/>
                                        <input name="nombre" class="caja_texto" type="text" value=""/><br/>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label>
                                        DNI<br/>
                                        <input name="DNI" class="caja_texto" type="text" value=""/><br/>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                             ...
                             <tr>
                                <td>
                                    <label>
                                        Lugar<br/>
                                        <input name="lugar" class="caja_texto" type="text" value=""/><br/>
                                    </label>
                                </td>
                            </tr>
                        </table>
                        ...
                        <fieldset id="botones_dar_alta_recurso_cliente">
                            <br/>
                            <table class="tabla_registrarse">
                                <tr>
                                    <td>
                ...
                <form id="formulario_darse_baja_recurso_cliente" name="formulario" method="POST" action="comprobar_darse_baja_recurso_cliente.php" onsubmit="return comprueba_baja_recurso(this)" enctype="multipart/form-data">
                    <br/>
                    <h1 id="tituloTexto_dar_baja_recurso_cliente"> Darse de baja </h1>
                    <fieldset class="iniciarSesion">
                        <table class="tabla_registrarse">
                            <tr>
                                <td>
                        ...
                        <fieldset id="botones_dar_baja_recurso_cliente">
                            <br/>
                            <table class="tabla_registrarse">
                                <tr>
                                    <td>
