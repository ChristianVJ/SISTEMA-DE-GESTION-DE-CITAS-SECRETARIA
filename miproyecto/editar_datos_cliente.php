...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// --> 
            ...
            <div id="cuerpo">
                ...
                <form method="post" action="editar_datos_profesional.php" onsubmit="return comprueba_editar_datos(this)" >
                    <h1 id="tituloTexto"> Modificar datos del cliente</h1>
                    <?php
                    ...
                    if (isset($_POST['nombre_registro'])) {
                        ...
                        $sql.= "WHERE DNI='" . $registro['DNI'] . "'";
                        $resultado = consultarA('75897720c', $sql);
                        echo "<script>alert('Datos modificados correctamente.');window.location.href='editar_datos_cliente.php';</script>";
                    }
