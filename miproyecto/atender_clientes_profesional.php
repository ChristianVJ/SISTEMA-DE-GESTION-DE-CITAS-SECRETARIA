...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// --> 
            ...
            <div id="cuerpo">
                ...
                <h1 id="tituloTexto"> Clientes en la cola</h1>
                <?php

                    require 'include.php';//referencia el fichero include en el que se realiza la conexión con la base de datos
                    // Tabla de los recursos
                    echo '<table id="tablaCuerpo">';
                    // Cabecera de la tabla
                    echo '<tr id = "cabecera_recursos"><td class="tdt1"><b>Código del recurso</b></td><td class="tdt1"><b>Código del cliente</b></td><td class="tdt1"><b>Lugar</b></td><td class="tdt1"><b>Hora de asignacion</b></td><td class="tdt1"><b>Estado</b></td></td></tr>';

                    // Insertamos en la variable, la consulta que recorre la tabla de recursos y muestra toda la información
                    $consulta = "SELECT * FROM recurso_asignado";
                    

                    //Envio la consulta a MySQL.
                    $resultado = consultarA('75897720c', $consulta);

                    // Mientras haya datos a mostrar, insertarlos en la tabla
                    while ($registroActual = mysql_fetch_array($resultado)) 
                    {
                        ...
                        echo '</td><td>';
                        echo '<a href="atender_clientes_profesional2.php?DNI=' . $registroActual['DNI'] . '"><b>X</b></a>';
