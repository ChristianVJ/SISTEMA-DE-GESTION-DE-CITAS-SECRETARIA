...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// --> 
            ...
            <div id="cuerpo">
                ...
                //consulto los datos del profesional
                ...
                <form method="post" action="editar_datos_profesional.php" onsubmit="return comprueba_editar_datos(this)" >
                    <br/>
                     <h1 id="tituloTexto"> Modificar datos del profesional</h1>
                    <?php
                    ...
                    $sql = "UPDATE usuarios SET ";
                        ...
                        echo "<script>alert('Datos modificados correctamente.');window.location.href='editar_datos_profesional.php';</script>";
                    }
