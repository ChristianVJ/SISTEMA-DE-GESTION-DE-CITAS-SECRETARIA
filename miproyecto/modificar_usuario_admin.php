...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// --> 
            ...
            <div id="cuerpo">
                <h1 id="tituloTexto"> Modificar usuarios </h1>
                <?php
                ...
                echo '<tr id = "cabecera_recursos"><td class="tdt1"><b>Nombre</b></td><td class="tdt1"><b>Apellidos</b></td><td class="tdt1"><b>e-mail</b></td><td class="tdt1"><b>Sexo</b></td><td class="tdt1"><b>DNI</b></td></td></tr>';
                ...
                while ($registroActual = mysql_fetch_array($resultado)) {
                    ...
                    echo '</td><td>';
                    echo $registroActual['sexo'];
                    echo '</td><td>';
                    echo $registroActual['DNI'];
                    echo '</td><td>';

                    // Enlace a modificar el usuario por un admin recibiendo el nombre
                    echo '<a href="modificar_usuario_admin2.php?nombre=' . $registroActual['nombre'] . '"><b>M</b></a>';
