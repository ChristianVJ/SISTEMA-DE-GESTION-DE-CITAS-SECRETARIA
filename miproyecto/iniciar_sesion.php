...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// --> 
            ...
            <div id="cuerpo">
                <!-- formulario para iniciar sesión, que pide nombre de usuario y contraseña -->
                <form method="post" action="comprobar_usuario.php" onsubmit="return comprueba_iniciar_sesion(this)"> <!--comprobar que los datos estan intorducidos en el formato corrector-->
                    <br/>
                    <h2 id="tituloTexto">Iniciar sesión</h2> 
                    <fieldset id="iniciarSesion">
                        <table id="tabla_registrarse">
                            <tr>
                                <td>
                                    <label>
                                        Usuario<br/>
                                        <input name="usuario" id="caja_texto" type="text" value=""/>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label>
                                        Contraseña <br/>
                                        <input name="clave" id="caja_texto" type="password" value="" />
                                    </label>
                                </td>
                            </tr>
